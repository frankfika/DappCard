...
export const tags: Record<string, TagDefinition> = {
  ...
  '二选一': { category: 'game', name: '二选一', icon: '⚖️', color: '#ce93d8', desc: '两难选择' },
  ...
  '荒岛求生': { category: 'game', name: '荒岛求生', icon: '🏝️', color: '#81c784', desc: '极端情境选择' },
  '破冰': { category: 'depth', name: '破冰', icon: '🧊', color: '#64b5f6', desc: '轻松开场' },
  '暖场': { category: 'depth', name: '暖场', icon: '☀️', color: '#ffb74d', desc: '打开话匣子' },
